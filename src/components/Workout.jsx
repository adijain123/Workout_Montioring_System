...
export default function Workout() {
  ...
  const [poseDetectionLoading, setPoseDetectionLoading] = useState(true);
        ...
        <div className="w-full max-w-2xl bg-gradient-to-b from-gray-800 to-blue-900 p-10 rounded-xl shadow-2xl border border-blue-800">
          ...
          <div className="bg-blue-900/30 p-6 rounded-lg border border-blue-800/50 mb-6">
            <p className="text-gray-200 text-lg mb-4">
              You need to be logged in to use the workout tracker features.
            </p>
            <p className="text-gray-300">
              Track your exercises, monitor progress, and get personalized
              recommendations.
            </p>
          </div>
            ...
            <Link to="/login" className="w-full sm:w-auto">
              <button className="w-full bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-lg text-lg font-semibold transition duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg flex items-center justify-center">
                ...
                >
                  <path
                    fillRule="evenodd"
                    d="M3 3a1 1 0 011-1h12a1 1 0 011 1v12a1 1 0 01-1 1H4a1 1 0 01-1-1V3zm5 10v-2a3 3 0 116 0v2h-6z"
                    clipRule="evenodd"
                  />
                </svg>
                Login
  ...
  return (
    <div className="flex flex-col items-center w-full p-6 bg-gradient-to-b from-gray-950 to-blue-950 text-gray-100 min-h-screen">
      <h1 className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-300 to-indigo-300 mb-8">
            ...
            <div className="bg-blue-900/50 p-4 rounded-lg border border-blue-700/50 mt-4">
              {exerciseType === "lunges" ? (
                <div className="flex items-start text-blue-200">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-6 w-6 mr-3 mt-1 flex-shrink-0 text-blue-300"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
                  ...
                  <p>
                    Lunges detection active. Bend both knees below 110° and
                    return to standing to count a rep.
                  </p>
                </div>
                ...
                <div className="flex items-start text-blue-200">
                  ...
                  <p>
                    Jumping jacks detection active. Move your arms from down
                    position to up position to count a rep.
                  </p>
                </div>
                ...
                <div className="flex items-start text-blue-200">
                  ...
                  <p>
                    Leg lift detection active. Lift your leg up from the floor
                    and return to count a rep.
                  </p>
                </div>
              ) : (
                <div className="flex items-start text-blue-200">
                  ...
                  <p>
                    Bicep curl detection active. Curl your arms to count reps.
                  </p>
                </div>
              )}
            </div>
      ...
      {showResults && (
        <div className="w-full max-w-5xl bg-gradient-to-b from-gray-800 to-blue-900 rounded-xl shadow-2xl p-8 border border-blue-800/30">
          <div className="flex items-center mb-6">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-10 w-10 mr-3 text-green-400"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
            ...
            <h2 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-300 to-blue-300">
              Workout Complete!
            </h2>
          </div>
            ...
            <div className="bg-gradient-to-b from-gray-900 to-gray-950 p-6 rounded-xl shadow-xl border border-blue-800/30">
              ...
              {loading ? (
                <div className="flex justify-center items-center h-64 bg-blue-900/30 rounded-lg border border-blue-800/50">
                  <div className="flex flex-col items-center">
                    <svg
                      className="animate-spin h-10 w-10 text-blue-400 mb-3"
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 24 24"
                    >
                  ...
                  <table className="min-w-full divide-y divide-gray-700">
                    ...
                    <tbody className="divide-y divide-gray-700">
                      {progress.map((session) => {
                        ...
                        const exerciseTypes = [
                          ...new Set(session.exercises.map((ex) => ex.type)),
                        ];
                        const displayTypes = exerciseTypes
                          .map((type) => getExerciseDisplayName(type))
                          .join(", ");
