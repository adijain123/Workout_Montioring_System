...
export function initLifting(videoElement, canvasElement, updateRepsStage, updateTime) {
  ...
  pose.onResults((results) => {
    ...
    drawText(`L READY: ${!leftArmCooldown ? 'YES' : 'NO'}`, 10, 120, !leftArmCooldown ? '#00FFCC' : '#FF3333');
    drawText(`R READY: ${!rightArmCooldown ? 'YES' : 'NO'}`, 10, 150, !rightArmCooldown ? '#00FFCC' : '#FF3333');
  });
